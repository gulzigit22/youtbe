...
class shorts2 extends StatelessWidget {
  shorts2({Key key}) : super(key: key);
        ...
        items: [
          BottomNavigationBarItem(
            icon: InkWell(
              ...
              child:
                  Padding(padding: EdgeInsets.all(8), child: Icon(Icons.home)),
            ),
            label: 'Home',
          ),
          BottomNavigationBarItem(
            icon: InkWell(
              ...
              child:
                  Padding(padding: EdgeInsets.all(8), child: Icon(Icons.face)),
            ),
            label: 'Shorts',
          ),
          BottomNavigationBarItem(
